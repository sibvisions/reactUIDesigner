    ...
    sendRequest({ formData: formData }, uploadUrl)
      .then(() => {
        if (toastRef.current) {
          ...
          localStorage.setItem("reactui-designer-scheme-" + props.appName, fileNameScheme.substring(0, fileNameScheme.indexOf(".")));
          localStorage.setItem("reactui-designer-theme" + props.appName, fileNameTheme.substring(0, fileNameTheme.indexOf(".")));
